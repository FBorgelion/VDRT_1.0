...
namespace DAL.Migrations
{
    ...
    [Migration("20260826091540_AddManualXmlImport")]
    partial class AddManualXmlImport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Imports.ImportBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ImportedTraceCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RejectedTraceCount")
                        .HasColumnType("int");

                    b.Property<int>("SkippedTraceCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Imports.ImportSourceFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ImportSourceFiles", (string)null);
                });

            modelBuilder.Entity("Domain.Imports.ImportedTrace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ActivityFinalReportRaw")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("ActivityLengthMilliseconds")
                        .HasColumnType("bigint");

                    b.Property<string>("ActivityLengthMillisecondsRaw")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("ActivityReportRaw")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("ActivityStartTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("ActivityStartTimeRaw")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("DeviceRaw")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("DriverIdsRaw")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<long?>("DrivingLengthMilliseconds")
                        .HasColumnType("bigint");

                    b.Property<string>("DrivingLengthMillisecondsRaw")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("SpeedRaw")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<DateTime?>("TechnicalTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("TechnicalTimeRaw")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("TraceTypeRaw")
                        .HasMaxLength(50)
                    ...
                    b.HasIndex("ImportSourceFileId", "Position")
                        .IsUnique();

                    b.ToTable("ImportedTraces", (string)null);
                });

            modelBuilder.Entity("Domain.Imports.ImportedTraceProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ImportedTraceId")
                        .HasColumnType("int");

                    b.Property<string>("KeyRaw")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasIndex("ImportedTraceId", "Position")
                        .IsUnique();

                    b.ToTable("ImportedTraceProperties", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Imports.ImportError", b =>
                {
                    b.HasOne("Domain.Imports.ImportBatch", "ImportBatch")
                        .WithMany("Errors")
                        .HasForeignKey("ImportBatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Imports.ImportSourceFile", "ImportSourceFile")
                        .WithMany("Errors")
            ...
            modelBuilder.Entity("Domain.Imports.ImportedTraceProperty", b =>
                {
                    b.HasOne("Domain.Imports.ImportedTrace", "ImportedTrace")
                        .WithMany("Properties")
                        .HasForeignKey("ImportedTraceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ImportedTrace");
                });
